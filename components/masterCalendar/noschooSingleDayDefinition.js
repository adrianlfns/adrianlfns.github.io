...
import "./noschoolSingleDayAnswer.js"


export class NoSchoolSingleMonthDefinition extends LitElement{
          ...
          for (let c = 0; c<5; c++ )
          {
            ...
            else
            {
              ...
              {                
                columns.push(html `  
                <td> 
                <noshcolsingle-day-answer .daydata=${oDayPointer}></noshcolsingle-day-answer>                 
                 </td>`);
                currentDayPointer++;
              }
              else
...
customElements.define('noschool-singlemonth-definition', NoSchoolSingleMonthDefinition);